<%-- 
    Document   : reservar-cita
    Created on : 18/03/2026, 9:43:18 p. m.
    Author     : Familia
--%>
...
<head>
    ...
    <title>Reservar Cita - Madhouse</title>
</head>
<body>
    <header>
        <h1>MADHOUSE</h1>
        <nav>
            <ul>
                ...
                <li><a href="barberos.jsp">Barberos</a></li>
                <li><a href="nosotros.jsp">Sobre Nosotros</a></li>
            </ul>
        </nav>
        <div class="boton">
            <button id="boton-horarios">Notificaciones (1)</button>
            <button id="boton-inicio-sesion">Cerrar Sesion</button>
        </div>
    </header>
    <a href="dashboard-cliente.jsp" class="link-volver">← Volver al Dashboard</a>

    <div class="container-reserva">
        
        <div id="paso-1" class="caja-formulario">
            <section class="texto">
            ...
            <div class="opciones-grid">
                <div class="opcion-tarjeta seleccionable">
                    <h3>Corte Premium</h3>
                    <p>45 min - $25.000</p>
                </div>
                <div class="opcion-tarjeta seleccionable">
            ...
            <div class="boton grupo-botones-derecha">
                <button id="btn-sig-1" class="btn-formulario btn-sig">Siguiente</button>
            </div>
        </div>

        <div id="paso-2" class="caja-formulario paso-oculto">
            <section class="texto">
            ...
            <div class="opciones-grid">
                <div class="opcion-tarjeta seleccionable">
                    <img src="img/barbero1.png" alt="Miguel" class="foto-barbero">
                    <h3>Miguel</h3>
                    <p>Especialista clasico</p>
                </div>
                <div class="opcion-tarjeta seleccionable">
                    <img src="img/barbero2.png" alt="Andres" class="foto-barbero">
                    <h3>Andres</h3>
                    <p>Estilos modernos</p>
                </div>
            </div>

            <div class="boton grupo-botones">
                <button id="btn-atras-2" class="btn-formulario btn-secundario">Atras</button>
                <button id="btn-sig-2" class="btn-formulario btn-sig">Siguiente</button>
            </div>
        </div>

        <div id="paso-3" class="caja-formulario paso-oculto">
            <section class="texto">
            ...
            <div class="campos-formulario">
                <label for="fecha-cita">Selecciona la Fecha:</label>
                <input type="date" id="fecha-cita">

                <label class="label-espaciado">Horas disponibles:</label>
                <div class="opciones-grid">
                    <div class="opcion-tarjeta seleccionable tarjeta-hora">2:00 PM</div>
                    <div class="opcion-tarjeta seleccionable tarjeta-hora">3:30 PM</div>
                    <div class="opcion-tarjeta seleccionable tarjeta-hora">5:00 PM</div>
                </div>
            </div>

            <div class="boton grupo-botones">
                <button id="btn-atras-3" class="btn-formulario btn-secundario">Atras</button>
                <button id="btn-sig-3" class="btn-formulario btn-sig">Siguiente -></button>
            </div>
        </div>

        <div id="paso-4" class="caja-formulario paso-oculto">
            <section class="texto">
                <h2>Forma de Pago</h2>
            ...
            <div class="boton grupo-botones">
                <button id="btn-atras-4" class="btn-formulario btn-secundario">Atras</button>
                <button id="btn-sig-4" class="btn-formulario btn-sig">Ver Resumen</button>
            </div>
        </div>

        <div id="paso-5" class="caja-formulario paso-oculto">
            <section class="texto">
            ...
            <div class="resumen-cita">
                ...
                <p><strong>Fecha:</strong> 28 Feb - 3:30 PM</p>
                <p><strong>Pago:</strong> Transferencia</p>
                <p class="total-resumen"><strong>Total: $35.000</strong></p>
            </div>

            <div class="boton grupo-botones">
                <button id="btn-atras-5" class="btn-formulario btn-secundario">Atras</button>
                <button id="boton-reservar" class="btn-formulario">¡Confirmar Cita!</button>
            </div>
        </div>
    </div>
