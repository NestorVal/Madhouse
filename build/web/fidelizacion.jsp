<%-- 
    Document   : fidelizacion
    Created on : 18/03/2026, 9:49:04 p. m.
    Author     : Familia
--%>
...
<head>
    ...
    <title>Madhouse - Sistema de Fidelización</title>
...
<body>
    ...
    <header>
        ...
        <div class="contenido-dashboard">
            ...
            <section class="texto">
                <h2 class="titulo-fidelizacion">Sistema de fidelización</h2>
            </section>

            <div class="tarjeta-blanca-puntos">
                <div class="puntos-badge-container">
                    <div class="icon-puntos-circular">🎁</div>
                    <div class="conteo-puntos">
                        <span class="numero-grande">150</span>
                        <p>puntos</p>
                    </div>
                </div>
                ...
                <div class="barra-progreso-container">
                    <div class="barra-progreso-fondo">
                        <div class="barra-progreso-lleno" style="width: 75%;"></div>
                    </div>
                    <p class="meta-puntos">Por cada servicio ganas 10 puntos</p>
                    <p class="promocion-fija">Cada 200 puntos = 1 servicio básico gratis</p>
                </div>

                <section class="texto-izq">
                ...
                <section class="texto-izq" style="margin-top: 30px;">
                    <h3>Historial</h3>
                </section>
                ...
                <div class="boton btn-centrado">
                    <button id="btn-canjear" class="btn-negro-lg">Canjear puntos</button>
                </div>
            </div>

            <div class="banner-informativo-lila">
                <p>💡 Acumula puntos con cada servicio y canjéalos por recompensas exclusivas</p>
            </div>
        </div>
    </div>
