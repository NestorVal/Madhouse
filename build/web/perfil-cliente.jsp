<%-- 
    ...
    Created on : 18/03/2026, 9:44:08 p. m.
    Author     : Familia
--%>
...
<head>
    ...
    <title>Madhouse - Mi perfil</title>
...
<body>
    ...
    <header>
        ...
        <div class="contenido-dashboard">
            ...
            <div class="tarjeta-perfil-lila">
                <div class="avatar-perfil">
                    <img src="img/foto-perfil.png" alt="Camilo">
                    <div class="badge-edit">✎</div>
                </div>

                <section class="texto-interno">
                    <h3>Información personal</h3>
                </section>

                <div class="datos-cliente">
                    <div class="dato"><strong>Nombre</strong> <span>Camilo Perez</span></div>
                    <div class="dato"><strong>Email</strong> <span>perez.camilo@gmail.com</span></div>
                    <div class="dato"><strong>Teléfono</strong> <span>3132852821</span></div>
                    <div class="dato"><strong>Fecha de nacimiento</strong> <span>15 de Marzo de 1990</span></div>
                </div>

                <div class="boton">
                    <button id="btn-editar-interno">Editar perfil</button>
                </div>
            </div>
            ...
            <div class="acciones-footer-perfil">
                <div class="boton">
                    <button id="btn-cambiar-pass" class="btn-full-width">Cambiar contraseña</button>
                </div>
                <div class="boton">
                    <button id="btn-editar-perfil" class="btn-full-width">Editar perfil</button>
                </div>
            </div>
        </div>
    </div>
