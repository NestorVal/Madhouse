<%-- 
    Document   : login
    Created on : 18/03/2026, 9:41:41 p. m.
    Author     : Familia
--%>
...
<body>
    ...
    <div class="container-login">
        ...
        <div id="seccion-login" class="caja-formulario">
            <section class="texto">
                <h2>Iniciar Sesion</h2>
                <p>Bienvenido de nuevo a Madhouse</p>
            </section>
            <div class="campos-formulario">
                <form action="LoginServlet" method="POST">
                    <!--<label for="rol-login">Rol de Usuario</label>
                    <select id="rol-login" name="txtRol">
                        <option value="cliente">Cliente</option>
                        <option value="barbero">Barbero</option>
                    </select>-->

                    <label for="correo-login">Correo Electronico</label>
                    <input type="email" name="txtCorreo" id="correo-log" placeholder="tucorreo@email.com">

                    <label for="pass-login">Contraseña</label>
                    <input type="password" name="txtPass" id="pass-login" placeholder="Tu contraseña">
                    <div class="boton">
                        <button type="submit" id="boton-reservar" class="btn-formulario">Ingresar</button>
                    </div>
                </form>
            </div>
            <p class="cambio-form">¿No tienes cuenta? <a href="#" id="ir-a-registro">Registrate aqui</a></p>
        </div>
    </div>
