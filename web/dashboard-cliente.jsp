<%-- 
    Document   : dashboard-cliente
    Created on : 18/03/2026, 9:49:47 p. m.
    Author     : Familia
--%>
...
<head>
    ...
    <title>Dashboard - Madhouse</title>
</head>
<body>
    <header>
        <h1>MADHOUSE</h1>
    ...
    <div class="container-dashboard">
        ...
        <div class="sidebar-perfil">
            <div class="info-usuario">
                <img src="img/foto-perfil.png" alt="Foto de perfil" class="foto-circular">
                <h3>Camilo Perez</h3>
                <p>Cliente VIP</p>
            </div>
            <nav class="menu-lateral">
                <button class="btn-menu btn-perfil activo">Mi Panel</button>
                <button class="btn-menu btn-reservas">Mis Reservas</button>
                <button class="btn-menu btn-fidelizacion">Club Madhouse (Puntos)</button>
                <button class="btn-menu btn-editar-perfil">Editar Perfil</button>
            </nav>
        </div>

        <div class="contenido-dashboard">
            <section class="texto texto-izq">
            ...
            <div class="tarjetas-resumen">
                ...
                <div class="tarjeta-dash tarjeta-centrada">
                    <div class="cabecera-tarjeta">
                        <h3>Mis Puntos Madhouse</h3>
                    </div>
                    <div class="puntos-info">
                        <h2 class="numero-puntos">1,250</h2>
                        <p>Puntos Acumulados</p>
                    </div>
                    <div class="boton">
                        <button id="boton-horarios" style="width: 100%; margin: 0; margin-top: 15px;">Canjear Premios</button>
                    </div>
                </div>
